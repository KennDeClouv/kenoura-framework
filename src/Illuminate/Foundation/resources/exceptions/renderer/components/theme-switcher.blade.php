...
>
    <button
        ...
        @click="menu = ! menu"
    >
        <x-kenoura-exceptions-renderer::icons.sun class="block h-5 w-5 dark:hidden" />
        <x-kenoura-exceptions-renderer::icons.moon class="hidden h-5 w-5 dark:block" />
    </button>
    ...
    >
        <button
            ...
            @click="lightMode()"
        >
            <x-kenoura-exceptions-renderer::icons.sun class="h-5 w-5" />
            Light
        </button>
        <button
            ...
            @click="darkMode()"
        >
            <x-kenoura-exceptions-renderer::icons.moon class="h-5 w-5" />
            Dark
        </button>
        <button
            ...
            @click="systemMode()"
        >
            <x-kenoura-exceptions-renderer::icons.computer-desktop class="h-5 w-5" />
            System
        </button>
    </div>
</div>
