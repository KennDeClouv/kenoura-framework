...
abstract class GeneratorCommand extends Command implements PromptsForMissingInput
{
    ...
    protected function getPath($name)
    {
        ...
        return $this->kenoura['path'].'/'.str_replace('\\', '/', $name).'.php';
    }
    ...
    {
        return $this->kenoura->getNamespace();
    }
    ...
    {
        $views = $this->kenoura['config']['view.paths'][0] ?? resource_path('views');
