...
class Application extends Container implements ApplicationContract, CachesConfiguration, CachesRoutes, HttpKernelInterface
{
    ...
    /**
     * The base path for the Kenoura installation.
     *
     * @var string
     */
    protected $basePath;
    ...
    public function __construct($basePath = null)
    {
        ...
        $this->registerKenouraCloudServices();
    }

    /**
     * Begin configuring a new Kenoura application instance.
     *
     * @param  string|null  $basePath
    ...
    /**
     * Register any services needed for Kenoura Cloud.
     *
     * @return void
     */
    protected function registerKenouraCloudServices()
    {
        if (! kenoura_cloud()) {
            return;
        }
    ...
    protected function bindPathsInContainer()
    {
        ...
        $this->useBootstrapPath(value(function () {
            return is_dir($directory = $this->basePath('.kenoura'))
                        ? $directory
    ...
    /**
     * Get the base path of the Kenoura installation.
     *
     * @param  string  $path
     * @return string
     */
    ...
    {
        if (isset($_ENV['KENOURA_STORAGE_PATH'])) {
            return $this->joinPaths($this->storagePath ?: $_ENV['KENOURA_STORAGE_PATH'], $path);
        }

        if (isset($_SERVER['KENOURA_STORAGE_PATH'])) {
            return $this->joinPaths($this->storagePath ?: $_SERVER['KENOURA_STORAGE_PATH'], $path);
        }
