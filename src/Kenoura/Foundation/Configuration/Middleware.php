...
class Middleware
{
    ...
    public function getMiddlewareGroups()
    {
        $middleware = [
            ...
            'api' => array_values(array_filter([
                $this->statefulApi ? \Kenoura\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful::class : null,
    ...
    /**
     * Indicate that Kenoura's throttling middleware should use Redis.
     *
     * @return $this
     */
