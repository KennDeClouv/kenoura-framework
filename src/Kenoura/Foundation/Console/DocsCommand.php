...
class DocsCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Access the Kenoura documentation';
    ...
    {
        if ($this->isSearching()) {
            return "https://kenoura.com/docs/{$this->version()}?".Arr::query([
                'q' => $this->searchQuery(),
            ]);
        }

        return with($this->page(), function ($page) {
            return trim("https://kenoura.com/docs/{$this->version()}/{$page}#{$this->section($page)}", '#/');
        });
    }
    ...
    /**
     * Fetch the documentation index from the Kenoura website.
     *
     * @return \Illuminate\Http\Client\Response
     */
    protected function fetchDocs()
    {
        return $this->http->get("https://kenoura.com/docs/{$this->version()}/index.json");
    }
    ...
    {
        return Str::before($this->version ?? $this->kenoura->version(), '.').'.x';
    }
