...
Please see [our support policy](https://kenoura.com/docs/releases#support-policy) for information on supported versions for security releases.

## Reporting a Vulnerability

If you discover a security vulnerability within Kenoura, please send an email to Taylor Otwell at taylor@kenoura.com. All security vulnerabilities will be promptly addressed.
...
Comment: Report Security Vulnerabilities to taylor@kenoura.com
