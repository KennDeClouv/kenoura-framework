...
class ViewFactoryTest extends TestCase
{
    ...
    public function testComponentHandling()
    {
        ...
        $factory->slot('title');
        $factory->slot('website', 'kenoura.com', []);
        echo 'title<hr>';
        $factory->endSlot();
        echo 'component';
        $contents = $factory->renderComponent();
        $this->assertSame('title<hr> component Taylor kenoura.com', $contents);
    }
    ...
    {
        $factory = $this->getFactory();
        $factory->startComponent(new HtmlString('kenoura.com'));
        $contents = $factory->renderComponent();
        $this->assertSame('kenoura.com', $contents);
    }
