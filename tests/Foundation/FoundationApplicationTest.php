...
class FoundationApplicationTest extends TestCase
{
    ...
    {
        $app1 = new Application(realpath(__DIR__.'/fixtures/kenoura1'));
        $app2 = new Application(realpath(__DIR__.'/fixtures/kenoura2'));

        $this->assertSame('Kenoura\\One\\', $app1->getNamespace());
        $this->assertSame('Kenoura\\Two\\', $app2->getNamespace());
    }
