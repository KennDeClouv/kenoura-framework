...
class ViewCacheCommand extends Command
{
    ...
    {
        $compiler = $this->kenoura['view']->getEngineResolver()->resolve('blade')->getCompiler();
    ...
    {
        $extensions = (new Collection($this->kenoura['view']->getExtensions()))
    ...
    {
        $finder = $this->kenoura['view']->getFinder();
