...
return [
    ...
    */
    ...
    | by Kenoura's translation / localization methods. This option can be
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This key is utilized by Kenoura's encryption services and should be set
    ...
    */
    ...
    | manage Kenoura's "maintenance mode" status. The "cache" driver will
