...
class DatabaseSQLiteSchemaGrammarTest extends TestCase
{
    ...
    public function testAddingForeignID()
    {
        ...
        $blueprint->foreignId('kenoura_idea_id')->constrained();
        ...
        $this->assertSame([
            ...
            'alter table "users" add column "kenoura_idea_id" integer not null',
            'create table "__temp__users" ("foo" integer not null, "company_id" integer not null, "kenoura_idea_id" integer not null, foreign key("company_id") references "companies"("id"), foreign key("kenoura_idea_id") references "kenoura_ideas"("id"))',
            'insert into "__temp__users" ("foo", "company_id", "kenoura_idea_id") select "foo", "company_id", "kenoura_idea_id" from "users"',
            'drop table "users"',
            'alter table "__temp__users" rename to "users"',
            'alter table "users" add column "team_id" integer not null',
            'create table "__temp__users" ("foo" integer not null, "company_id" integer not null, "kenoura_idea_id" integer not null, "team_id" integer not null, foreign key("company_id") references "companies"("id"), foreign key("kenoura_idea_id") references "kenoura_ideas"("id"), foreign key("team_id") references "teams"("id"))',
            'insert into "__temp__users" ("foo", "company_id", "kenoura_idea_id", "team_id") select "foo", "company_id", "kenoura_idea_id", "team_id" from "users"',
            'drop table "users"',
            'alter table "__temp__users" rename to "users"',
            'alter table "users" add column "team_column_id" integer not null',
            'create table "__temp__users" ("foo" integer not null, "company_id" integer not null, "kenoura_idea_id" integer not null, "team_id" integer not null, "team_column_id" integer not null, foreign key("company_id") references "companies"("id"), foreign key("kenoura_idea_id") references "kenoura_ideas"("id"), foreign key("team_id") references "teams"("id"), foreign key("team_column_id") references "teams"("id"))',
            'insert into "__temp__users" ("foo", "company_id", "kenoura_idea_id", "team_id", "team_column_id") select "foo", "company_id", "kenoura_idea_id", "team_id", "team_column_id" from "users"',
            'drop table "users"',
            'alter table "__temp__users" rename to "users"',
        ], $statements);
    }
    ...
    public function testAddingForeignUuid()
    {
        ...
        $blueprint->foreignUuid('kenoura_idea_id')->constrained();
        ...
        $this->assertSame([
            ...
            'drop table "users"',
            'alter table "__temp__users" rename to "users"',
            'alter table "users" add column "kenoura_idea_id" varchar not null',
            'create table "__temp__users" ("foo" varchar not null, "company_id" varchar not null, "kenoura_idea_id" varchar not null, foreign key("company_id") references "companies"("id"), foreign key("kenoura_idea_id") references "kenoura_ideas"("id"))',
            'insert into "__temp__users" ("foo", "company_id", "kenoura_idea_id") select "foo", "company_id", "kenoura_idea_id" from "users"',
            'drop table "users"',
            'alter table "__temp__users" rename to "users"',
            'alter table "users" add column "team_id" varchar not null',
            'create table "__temp__users" ("foo" varchar not null, "company_id" varchar not null, "kenoura_idea_id" varchar not null, "team_id" varchar not null, foreign key("company_id") references "companies"("id"), foreign key("kenoura_idea_id") references "kenoura_ideas"("id"), foreign key("team_id") references "teams"("id"))',
            'insert into "__temp__users" ("foo", "company_id", "kenoura_idea_id", "team_id") select "foo", "company_id", "kenoura_idea_id", "team_id" from "users"',
            'drop table "users"',
            'alter table "__temp__users" rename to "users"',
            'alter table "users" add column "team_column_id" varchar not null',
            'create table "__temp__users" ("foo" varchar not null, "company_id" varchar not null, "kenoura_idea_id" varchar not null, "team_id" varchar not null, "team_column_id" varchar not null, foreign key("company_id") references "companies"("id"), foreign key("kenoura_idea_id") references "kenoura_ideas"("id"), foreign key("team_id") references "teams"("id"), foreign key("team_column_id") references "teams"("id"))',
            'insert into "__temp__users" ("foo", "company_id", "kenoura_idea_id", "team_id", "team_column_id") select "foo", "company_id", "kenoura_idea_id", "team_id", "team_column_id" from "users"',
            'drop table "users"',
            'alter table "__temp__users" rename to "users"',
        ], $statements);
