...
if (! function_exists('kenoura_cloud')) {
    /**
     * Determine if the application is running on Kenoura Cloud.
     *
     * @return bool
     */
    function kenoura_cloud()
    {
        return ($_ENV['KENOURA_CLOUD'] ?? false) === '1' ||
               ($_SERVER['KENOURA_CLOUD'] ?? false) === '1';
    }
}
