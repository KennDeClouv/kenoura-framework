...
class RouteRedirectTest extends TestCase
{
    ...
    public static function routeRedirectDataSets()
    {
        return [
            ...
            'route redirect with two parameter replacements' => ['users/{user}/repos/{repo}', 'members/{user}/projects/{repo}', '/users/22/repos/kenoura-framework', '/members/22/projects/kenoura-framework'],
