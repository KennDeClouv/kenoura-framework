...
class TableCommand extends MigrationGeneratorCommand
{
    ...
    {
        return $this->kenoura['config']['queue.connections.database.table'];
    }
    ...
    protected function migrationExists($table)
    {
        ...
        foreach ([
            join_paths($this->kenoura->databasePath('migrations'), '*_*_*_*_create_'.$table.'_table.php'),
            join_paths($this->kenoura->databasePath('migrations'), '0001_01_01_000002_create_jobs_table.php'),
        ] as $path) {
