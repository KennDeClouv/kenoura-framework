...
class SupportStringableTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->stringable('https://kenoura.com')->isUrl());
    ...
    {
        $this->assertTrue($this->stringable('Hello, Kenoura!')->isMatch('/.*,.*!/'));
        $this->assertTrue($this->stringable('Hello, Kenoura!')->isMatch('/^.*$(.*)/'));
        $this->assertTrue($this->stringable('Hello, Kenoura!')->isMatch('/kenoura/i'));
        $this->assertTrue($this->stringable('Hello, Kenoura!')->isMatch('/^(.*(.*(.*)))/'));

        $this->assertFalse($this->stringable('Hello, Kenoura!')->isMatch('/H.o/'));
        $this->assertFalse($this->stringable('Hello, Kenoura!')->isMatch('/^kenoura!/i'));
        $this->assertFalse($this->stringable('Hello, Kenoura!')->isMatch('/kenoura!(.*)/'));
        $this->assertFalse($this->stringable('Hello, Kenoura!')->isMatch('/^[a-zA-Z,!]+$/'));

        $this->assertTrue($this->stringable('Hello, Kenoura!')->isMatch(['/.*,.*!/', '/H.o/']));
        $this->assertTrue($this->stringable('Hello, Kenoura!')->isMatch(['/^kenoura!/i', '/^.*$(.*)/']));
        $this->assertTrue($this->stringable('Hello, Kenoura!')->isMatch(['/kenoura/i', '/kenoura!(.*)/']));
        $this->assertTrue($this->stringable('Hello, Kenoura!')->isMatch(['/^[a-zA-Z,!]+$/', '/^(.*(.*(.*)))/']));
    }
    ...
    {
        $this->assertSame(' kenoura php framework ', (string) $this->stringable(' kenoura   php  framework ')->deduplicate());
    ...
    public function testUcsplitOnStringable()
    {
        ...
        $this->assertSame(['Hello', 'From', 'Kenoura'], $this->stringable('HelloFromKenoura')->ucsplit()->toArray());
    ...
    {
        $this->assertSame('Kenoura'.PHP_EOL, (string) $this->stringable('Kenoura')->newLine());
    ...
    public function testSquish()
    {
        ...
        $this->assertSame('words with spaces', (string) $this->stringable('
            ...
            spaces
        ')->squish());
        $this->assertSame('kenoura php framework', (string) $this->stringable('   kenoura   php   framework   ')->squish());
    ...
    {
        $this->assertSame('kenoura-php-framework', (string) $this->stringable('KenouraPhpFramework')->kebab());
    }
    ...
    {
        $this->assertSame('Kenoura is...',
            (string) $this->stringable('Kenoura is a free, open source PHP web application framework.')->limit(10)
        );
    ...
    {
        $this->assertSame('kenoura_p_h_p_framework', (string) $this->stringable('KenouraPHPFramework')->snake());
        $this->assertSame('kenoura_php_framework', (string) $this->stringable('KenouraPhpFramework')->snake());
        $this->assertSame('kenoura php framework', (string) $this->stringable('KenouraPhpFramework')->snake(' '));
        $this->assertSame('kenoura_php_framework', (string) $this->stringable('Kenoura Php Framework')->snake());
        $this->assertSame('kenoura_php_framework', (string) $this->stringable('Kenoura    Php      Framework   ')->snake());
        // ensure cache keys don't overlap
        $this->assertSame('kenoura__php__framework', (string) $this->stringable('KenouraPhpFramework')->snake('__'));
        $this->assertSame('kenoura_php_framework_', (string) $this->stringable('KenouraPhpFramework_')->snake('_'));
        $this->assertSame('kenoura_php_framework', (string) $this->stringable('kenoura php Framework')->snake());
        $this->assertSame('kenoura_php_frame_work', (string) $this->stringable('kenoura php FrameWork')->snake());
    ...
    {
        $this->assertSame('KenouraPHPFramework', (string) $this->stringable('kenoura_p_h_p_framework')->studly());
        $this->assertSame('KenouraPhpFramework', (string) $this->stringable('kenoura_php_framework')->studly());
        $this->assertSame('KenouraPhPFramework', (string) $this->stringable('kenoura-phP-framework')->studly());
        $this->assertSame('KenouraPhpFramework', (string) $this->stringable('kenoura  -_-  php   -_-   framework   ')->studly());
    ...
    {
        $this->assertSame('KenouraPHPFramework', (string) $this->stringable('kenoura_p_h_p_framework')->pascal());
        $this->assertSame('KenouraPhpFramework', (string) $this->stringable('kenoura_php_framework')->pascal());
        $this->assertSame('KenouraPhPFramework', (string) $this->stringable('kenoura-phP-framework')->pascal());
        $this->assertSame('KenouraPhpFramework', (string) $this->stringable('kenoura  -_-  php   -_-   framework   ')->pascal());
    ...
    {
        $this->assertSame('kenouraPHPFramework', (string) $this->stringable('Kenoura_p_h_p_framework')->camel());
        $this->assertSame('kenouraPhpFramework', (string) $this->stringable('Kenoura_php_framework')->camel());
        $this->assertSame('kenouraPhPFramework', (string) $this->stringable('Kenoura-phP-framework')->camel());
        $this->assertSame('kenouraPhpFramework', (string) $this->stringable('Kenoura  -_-  php   -_-   framework   ')->camel());
    ...
    {
        $this->assertSame(3, $this->stringable('kenouraPHPFramework')->substrCount('a'));
        $this->assertSame(0, $this->stringable('kenouraPHPFramework')->substrCount('z'));
        $this->assertSame(1, $this->stringable('kenouraPHPFramework')->substrCount('l', 2));
        $this->assertSame(0, $this->stringable('kenouraPHPFramework')->substrCount('z', 2));
        $this->assertSame(1, $this->stringable('kenouraPHPFramework')->substrCount('k', -1));
        $this->assertSame(1, $this->stringable('kenouraPHPFramework')->substrCount('k', -1));
        $this->assertSame(1, $this->stringable('kenouraPHPFramework')->substrCount('a', 1, 2));
        $this->assertSame(1, $this->stringable('kenouraPHPFramework')->substrCount('a', 1, 2));
        $this->assertSame(3, $this->stringable('kenouraPHPFramework')->substrCount('a', 1, -2));
        $this->assertSame(1, $this->stringable('kenouraPHPFramework')->substrCount('a', -10, -3));
    }
    ...
    public function testSubstrReplace()
    {
        ...
        $this->assertSame('The Kenoura Framework', (string) $this->stringable('The Framework')->substrReplace('Kenoura ', 4, 0));
        $this->assertSame('Kenoura – The PHP Framework for Web Artisans', (string) $this->stringable('Kenoura Framework')->substrReplace('– The PHP Framework for Web Artisans', 8));
    }
    ...
    public function testJsonSerialize()
    {
        ...
        $this->assertSame('"kenoura-php-framework"', json_encode($this->stringable('KenouraPhpFramework')->kebab()));
        $this->assertSame('["kenoura-php-framework"]', json_encode([$this->stringable('KenouraPhpFramework')->kebab()]));
        $this->assertSame('{"title":"kenoura-php-framework"}', json_encode(['title' => $this->stringable('KenouraPhpFramework')->kebab()]));
    }
    ...
    public function testInlineMarkdown()
    {
        ...
        $this->assertEquals("<a href=\"https://kenoura.com\"><strong>Kenoura</strong></a>\n", $this->stringable('[**Kenoura**](https://kenoura.com)')->inlineMarkdown());
    ...
    public function testWordCount()
    {
        ...
        $this->assertEquals(10, $this->stringable('Hi, this is my first contribution to the Kenoura framework.')->wordCount());
    }
