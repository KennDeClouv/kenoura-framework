...
class RouteViewTest extends TestCase
{
    ...
    {
        Route::view('route', 'view', ['foo' => 'bar'], 418, ['Framework' => 'Kenoura']);

        View::addLocation(__DIR__.'/Fixtures');

        $this->assertSame('Kenoura', $this->get('/route')->headers->get('Framework'));
    }

    public function testRouteViewOverloadingStatusWithHeaders()
    {
        Route::view('route', 'view', ['foo' => 'bar'], ['Framework' => 'Kenoura']);
