...
class DatabasePostgresSchemaGrammarTest extends TestCase
{
    ...
    public function testAddingForeignID()
    {
        ...
        $this->assertSame([
            ...
            'alter table "users" add column "kenoura_idea_id" bigint not null',
            'alter table "users" add constraint "users_kenoura_idea_id_foreign" foreign key ("kenoura_idea_id") references "kenoura_ideas" ("id")',
    ...
    public function testAddingForeignUuid()
    {
        ...
        $this->assertSame([
            ...
            'alter table "users" add constraint "users_company_id_foreign" foreign key ("company_id") references "companies" ("id")',
            'alter table "users" add column "kenoura_idea_id" uuid not null',
            'alter table "users" add constraint "users_kenoura_idea_id_foreign" foreign key ("kenoura_idea_id") references "kenoura_ideas" ("id")',
