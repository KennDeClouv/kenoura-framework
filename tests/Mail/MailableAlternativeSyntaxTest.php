...
class MailableAlternativeSyntaxTest extends TestCase
{
    public function testBasicMailableInspection()
    {
        ...
        $this->assertTrue($mailable->hasCc('adam@kenoura.com'));
        $this->assertTrue($mailable->hasBcc('tyler@kenoura.com'));
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertFalse($mailable->hasTo('taylor@kenoura.com', 'Wrong Name'));

        $mailable->to(new Address('abigail@kenoura.com', 'Abigail Otwell'));
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com', 'Taylor Otwell'));
...
class MailableWithAlternativeSyntax extends Mailable
{
    ...
    {
        return new Envelope(
            to: [new Address('taylor@kenoura.com', 'Taylor Otwell')],
            cc: [new Address('adam@kenoura.com', 'Adam Wathan')],
            bcc: [new Address('tyler@kenoura.com', 'Tyler Blair')],
