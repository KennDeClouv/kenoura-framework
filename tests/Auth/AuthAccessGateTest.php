...
class AuthAccessGateTest extends TestCase
{
    ...
    {
        unset($_SERVER['__kenoura.testBefore']);
        ...
        $this->assertTrue($_SERVER['__kenoura.testBefore']);
    ...
    {
        $_SERVER['__kenoura.testBefore'] = false;
        ...
        $this->assertTrue($gate->check('edit', new AccessGateTestDummy));
        $this->assertFalse($gate->check('update', new AccessGateTestDummy));
        $this->assertFalse($_SERVER['__kenoura.testBefore']);
    ...
    {
        $_SERVER['__kenoura.gateBefore'] = false;
        $_SERVER['__kenoura.gateBefore2'] = false;
        $_SERVER['__kenoura.gateAfter'] = false;
        $_SERVER['__kenoura.gateAfter2'] = false;
        ...
        $gate->before(function (?stdClass $user) {
            $_SERVER['__kenoura.gateBefore'] = true;
        });

        $gate->after(function (?stdClass $user) {
            $_SERVER['__kenoura.gateAfter'] = true;
        });

        $gate->before(function (stdClass $user) {
            $_SERVER['__kenoura.gateBefore2'] = true;
        });

        $gate->after(function (stdClass $user) {
            $_SERVER['__kenoura.gateAfter2'] = true;
        });
        ...
        $this->assertTrue($_SERVER['__kenoura.gateBefore']);
        $this->assertFalse($_SERVER['__kenoura.gateBefore2']);
        $this->assertTrue($_SERVER['__kenoura.gateAfter']);
        $this->assertFalse($_SERVER['__kenoura.gateAfter2']);

        unset(
            $_SERVER['__kenoura.gateBefore'],
            $_SERVER['__kenoura.gateBefore2'],
            $_SERVER['__kenoura.gateAfter'],
            $_SERVER['__kenoura.gateAfter2']
        );
    }
...
class AccessGateTestPolicyThatAllowsGuests
{
    ...
    {
        $_SERVER['__kenoura.testBefore'] = true;
    }
