...
class EloquentEagerLoadingLimitTest extends DatabaseTestCase
{
    ...
    public function testBelongsToMany(): void
    {
        ...
        $this->assertArrayNotHasKey('kenoura_row', $users[0]->roles[0]);
        $this->assertArrayNotHasKey('@kenoura_group := `user_id`', $users[0]->roles[0]);
    }
    ...
    public function testHasMany(): void
    {
        ...
        $this->assertArrayNotHasKey('kenoura_row', $users[0]->posts[0]);
        $this->assertArrayNotHasKey('@kenoura_group := `user_id`', $users[0]->posts[0]);
    }
    ...
    public function testHasManyThrough(): void
    {
        ...
        $this->assertArrayNotHasKey('kenoura_row', $users[0]->comments[0]);
        $this->assertArrayNotHasKey('@kenoura_group := `user_id`', $users[0]->comments[0]);
    }
