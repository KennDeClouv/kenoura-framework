...
class ContextTest extends TestCase
{
    ...
    public function test_it_adds_context_to_logging()
    {
        ...
        $log = Str::after(file_get_contents(storage_path('logs/kenoura.log')), '] ');

        $this->assertSame('testing.INFO: My name is Tim {"name":"Tim","framework":"Kenoura"} {"trace_id":"expected-trace-id","foo.bar":123,"bar.baz":[456,789]}', trim($log));
