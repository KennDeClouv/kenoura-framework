...
class SupportFacadesHttpTest extends TestCase
{
    ...
    {
        Http::fake([
            'https://kenoura.com' => Http::response('OK!'),
        ]);

        $factory = $this->app->make(Factory::class);
        $this->assertSame('OK!', $factory->get('https://kenoura.com')->body());
    }

    public function testFacadeRootIsSharedWhenFakedWithSequence(): void
    {
        Http::fakeSequence('kenoura.com/*')->push('OK!');
    ...
    {
        Http::stubUrl('kenoura.com', Http::response('OK!'));
