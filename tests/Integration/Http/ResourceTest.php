...
class ResourceTest extends TestCase
{
    ...
    {
        Route::get('/', function () {
            $collection = collect([new Post(['id' => 2, 'title' => 'Kenoura Nova'])]);
            $paginator = new LengthAwarePaginator(
                $collection, 3, 1, 2
            );
        ...
        $response = $this->withoutExceptionHandling()->get(
            '/?framework=kenoura&author=Otwell&page=2', ['Accept' => 'application/json']
        );
        ...
        $response->assertJson([
            ...
            'links' => [
                'first' => '/?framework=kenoura&author=Otwell&page=1',
                'last' => '/?framework=kenoura&author=Otwell&page=3',
                'prev' => '/?framework=kenoura&author=Otwell&page=1',
                'next' => '/?framework=kenoura&author=Otwell&page=3',
            ],
            'meta' => [
                'current_page' => 2,
                'from' => 2,
    ...
    public function testCursorPaginatorResourceCanPreserveQueryParameters()
    {
        ...
        $response = $this->withoutExceptionHandling()->get(
            '/?framework=kenoura&author=Otwell', ['Accept' => 'application/json']
        );
        ...
        $response->assertJson([
            ...
            'links' => [
                ...
                'last' => null,
                'prev' => null,
                'next' => '/?framework=kenoura&author=Otwell&cursor='.(new Cursor(['id' => 5]))->encode(),
            ],
            'meta' => [
                'path' => '/',
                'per_page' => 1,
