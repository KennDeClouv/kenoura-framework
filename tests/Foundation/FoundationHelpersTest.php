...
class FoundationHelpersTest extends TestCase
{
    ...
    {
        $path = $this->makeHotModuleReloadFile('https://kenoura.com/docs');

        $result = mix('unversioned.css');

        $this->assertSame('//kenoura.com/docs/unversioned.css', $result->toHtml());
    ...
    {
        $path = $this->makeHotModuleReloadFile('http://kenoura.com/docs');
    ...
    {
        mkdir($directory = __DIR__.'/mix');
        $path = $this->makeHotModuleReloadFile('https://kenoura.com/docs', 'mix');
    ...
    {
        mkdir($directory = __DIR__.'/mix');
        $path = $this->makeHotModuleReloadFile('http://kenoura.com/docs', 'mix');
    ...
    protected function makeHotModuleReloadFile($url, $directory = '')
    {
        ...
        // Kenoura mix when run 'hot' has a new line after the
    ...
    protected function makeManifest($directory = '')
    {
        ...
        // Kenoura mix prints JSON pretty and with escaped
