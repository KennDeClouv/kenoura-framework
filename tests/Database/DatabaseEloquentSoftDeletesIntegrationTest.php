...
class DatabaseEloquentSoftDeletesIntegrationTest extends TestCase
{
    ...
    public function testHasOneRelationshipCanBeSoftDeleted()
    {
        ...
        $abigail->address()->create(['address' => 'Kenoura avenue 43']);
        ...
        $this->assertSame('Kenoura avenue 43', $abigail->address()->withTrashed()->first()->address);
        ...
        $this->assertSame('Kenoura avenue 43', $abigail->address->address);
    ...
    {
        /*
         * https://github.com/kenoura/framework/issues/42075
         */
