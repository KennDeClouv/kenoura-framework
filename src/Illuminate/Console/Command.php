...
class Command extends SymfonyCommand
{
    ...
    /**
     * The Kenoura application instance.
     *
    ...
    {
        $this->output = $output instanceof OutputStyle ? $output : $this->kenoura->make(
            OutputStyle::class, ['input' => $input, 'output' => $output]
        );

        $this->components = $this->kenoura->make(Factory::class, ['output' => $this->output]);
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            return (int) $this->kenoura->call([$this, $method]);
    ...
    {
        return $this->kenoura->bound(CommandMutex::class)
            ? $this->kenoura->make(CommandMutex::class)
            : $this->kenoura->make(CacheCommandMutex::class);
    }
    ...
    protected function resolveCommand($command)
    {
        if (is_string($command)) {
            ...
            $command = $this->kenoura->make($command);
        }
        ...
        if ($command instanceof self) {
            $command->setKenoura($this->getKenoura());
        }
    ...
    /**
     * Get the Kenoura application instance.
     *
     * @return \Illuminate\Contracts\Foundation\Application
     */
    public function getKenoura()
    {
        return $this->kenoura;
    }

    /**
     * Set the Kenoura application instance.
     *
     * @param  \Illuminate\Contracts\Container\Container  $kenoura
     * @return void
     */
    public function setKenoura($kenoura)
    {
        $this->kenoura = $kenoura;
    }
}
