...
class MailMailableTest extends TestCase
{
    ...
    public function testMailableSetsRecipientsCorrectly()
    {
        ...
        $mailable->to('taylor@kenoura.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->to);
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com'));
        $mailable->assertHasTo('taylor@kenoura.com');
        $mailable->to('taylor@kenoura.com', 'Taylor Otwell');

        // Add the same recipient again, but with a different name. This should set the name correctly.
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com', 'Taylor Otwell'));
        $mailable->assertHasTo('taylor@kenoura.com', 'Taylor Otwell');

        $mailable = new WelcomeMailableStub;
        $mailable->to('taylor@kenoura.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->to);
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com'));
        $mailable->assertHasTo('taylor@kenoura.com', 'Taylor Otwell');
        $mailable->assertHasTo('taylor@kenoura.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->to);
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com'));
        $this->assertFalse($mailable->hasTo('taylor@kenoura.com', 'Taylor Otwell'));
        $mailable->assertHasTo('taylor@kenoura.com');
        try {
            $mailable->assertHasTo('taylor@kenoura.com', 'Taylor Otwell');
            $this->fail();
        } catch (AssertionFailedError $e) {
            $this->assertSame("Did not see expected recipient [taylor@kenoura.com (Taylor Otwell)] in email 'to' recipients.\nFailed asserting that false is true.", $e->getMessage());
        }

        $mailable = new WelcomeMailableStub;
        $mailable->to([['name' => 'Taylor Otwell', 'email' => 'taylor@kenoura.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->to);
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com'));
        $mailable->assertHasTo('taylor@kenoura.com');
        ...
        $this->assertEquals([
            ['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com'],
            ['name' => 'Kenoura Framework', 'address' => 'contact@kenoura.com'],
        ], $mailable->to);
        $this->assertTrue($mailable->hasTo(new MailableTestUserStub));
        $this->assertTrue($mailable->hasTo('taylor@kenoura.com'));
        $mailable->assertHasTo('taylor@kenoura.com');
    ...
    public function testMailableSetsCcRecipientsCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->cc('taylor@kenoura.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@kenoura.com'));
        $mailable->assertHasCc('taylor@kenoura.com');

        $mailable = new WelcomeMailableStub;
        $mailable->cc('taylor@kenoura.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasCc('taylor@kenoura.com'));
        $mailable->assertHasCc('taylor@kenoura.com', 'Taylor Otwell');
        $mailable->assertHasCc('taylor@kenoura.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@kenoura.com'));
        $this->assertFalse($mailable->hasCc('taylor@kenoura.com', 'Taylor Otwell'));
        $mailable->assertHasCc('taylor@kenoura.com');
        try {
            $mailable->assertHasCc('taylor@kenoura.com', 'Taylor Otwell');
            $this->fail();
        } catch (AssertionFailedError $e) {
            $this->assertSame("Did not see expected recipient [taylor@kenoura.com (Taylor Otwell)] in email 'cc' recipients.\nFailed asserting that false is true.", $e->getMessage());
        }

        $mailable = new WelcomeMailableStub;
        $mailable->cc([['name' => 'Taylor Otwell', 'email' => 'taylor@kenoura.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasCc('taylor@kenoura.com'));
        $mailable->assertHasCc('taylor@kenoura.com', 'Taylor Otwell');
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->cc(['taylor@kenoura.com', 'not-taylor@kenoura.com']);
        $this->assertEquals([
            ['name' => null, 'address' => 'taylor@kenoura.com'],
            ['name' => null, 'address' => 'not-taylor@kenoura.com'],
        ], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@kenoura.com'));
        $this->assertTrue($mailable->hasCc('not-taylor@kenoura.com'));
        $mailable->assertHasCc('taylor@kenoura.com');
        $mailable->assertHasCc('not-taylor@kenoura.com');
    ...
    public function testMailableSetsBccRecipientsCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->bcc('taylor@kenoura.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@kenoura.com'));
        $mailable->assertHasBcc('taylor@kenoura.com');

        $mailable = new WelcomeMailableStub;
        $mailable->bcc('taylor@kenoura.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasBcc('taylor@kenoura.com'));
        $mailable->assertHasBcc('taylor@kenoura.com', 'Taylor Otwell');
        $mailable->assertHasBcc('taylor@kenoura.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@kenoura.com'));
        $this->assertFalse($mailable->hasBcc('taylor@kenoura.com', 'Taylor Otwell'));
        $mailable->assertHasBcc('taylor@kenoura.com');
        try {
            $mailable->assertHasBcc('taylor@kenoura.com', 'Taylor Otwell');
            $this->fail();
        } catch (AssertionFailedError $e) {
            $this->assertSame("Did not see expected recipient [taylor@kenoura.com (Taylor Otwell)] in email 'bcc' recipients.\nFailed asserting that false is true.", $e->getMessage());
        }

        $mailable = new WelcomeMailableStub;
        $mailable->bcc([['name' => 'Taylor Otwell', 'email' => 'taylor@kenoura.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasBcc('taylor@kenoura.com'));
        $mailable->assertHasBcc('taylor@kenoura.com', 'Taylor Otwell');
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->bcc(['taylor@kenoura.com', 'not-taylor@kenoura.com']);
        $this->assertEquals([
            ['name' => null, 'address' => 'taylor@kenoura.com'],
            ['name' => null, 'address' => 'not-taylor@kenoura.com'],
        ], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@kenoura.com'));
        $this->assertTrue($mailable->hasBcc('not-taylor@kenoura.com'));
        $mailable->assertHasBcc('taylor@kenoura.com');
        $mailable->assertHasBcc('not-taylor@kenoura.com');
    ...
    public function testMailableSetsReplyToCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->replyTo('taylor@kenoura.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->replyTo);
        $this->assertTrue($mailable->hasReplyTo('taylor@kenoura.com'));
        $mailable->assertHasReplyTo('taylor@kenoura.com');

        $mailable = new WelcomeMailableStub;
        $mailable->replyTo('taylor@kenoura.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->replyTo);
        $this->assertTrue($mailable->hasReplyTo('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasReplyTo('taylor@kenoura.com'));
        $mailable->assertHasReplyTo('taylor@kenoura.com', 'Taylor Otwell');
        $mailable->assertHasReplyTo('taylor@kenoura.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->replyTo);
        $this->assertTrue($mailable->hasReplyTo('taylor@kenoura.com'));
        $this->assertFalse($mailable->hasReplyTo('taylor@kenoura.com', 'Taylor Otwell'));
        $mailable->assertHasReplyTo('taylor@kenoura.com');
        try {
            $mailable->assertHasReplyTo('taylor@kenoura.com', 'Taylor Otwell');
            $this->fail();
        } catch (AssertionFailedError $e) {
            $this->assertSame("Did not see expected address [taylor@kenoura.com (Taylor Otwell)] as email 'reply to' recipient.\nFailed asserting that false is true.", $e->getMessage());
        }

        $mailable = new WelcomeMailableStub;
        $mailable->replyTo([['name' => 'Taylor Otwell', 'email' => 'taylor@kenoura.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->replyTo);
        $this->assertTrue($mailable->hasReplyTo('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasReplyTo('taylor@kenoura.com'));
        $mailable->assertHasReplyTo('taylor@kenoura.com');
    ...
    public function testMailableSetsFromCorrectly()
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->from('taylor@kenoura.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->from);
        $this->assertTrue($mailable->hasFrom('taylor@kenoura.com'));
        $mailable->assertFrom('taylor@kenoura.com');

        $mailable = new WelcomeMailableStub;
        $mailable->from('taylor@kenoura.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->from);
        $this->assertTrue($mailable->hasFrom('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasFrom('taylor@kenoura.com'));
        $mailable->assertFrom('taylor@kenoura.com', 'Taylor Otwell');
        $mailable->assertFrom('taylor@kenoura.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@kenoura.com']], $mailable->from);
        $this->assertTrue($mailable->hasFrom('taylor@kenoura.com'));
        $this->assertFalse($mailable->hasFrom('taylor@kenoura.com', 'Taylor Otwell'));
        $mailable->assertFrom('taylor@kenoura.com');
        try {
            $mailable->assertFrom('taylor@kenoura.com', 'Taylor Otwell');
            $this->fail();
        } catch (AssertionFailedError $e) {
            $this->assertSame("Email was not from expected address [taylor@kenoura.com (Taylor Otwell)].\nFailed asserting that false is true.", $e->getMessage());
        }

        $mailable = new WelcomeMailableStub;
        $mailable->from([['name' => 'Taylor Otwell', 'email' => 'taylor@kenoura.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@kenoura.com']], $mailable->from);
        $this->assertTrue($mailable->hasFrom('taylor@kenoura.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasFrom('taylor@kenoura.com'));
        $mailable->assertFrom('taylor@kenoura.com', 'Taylor Otwell');
    ...
    public function testMailableBuildsViewData()
    {
        ...
        $expected = [
            ...
            'lastName' => 'Otwell',
            'framework' => 'Kenoura',
            '__kenoura_mailable' => get_class($mailable),
        ];
    ...
    public function testMailablePriorityGetsSent()
    {
        ...
        $this->assertSame('hello@kenoura.com', $sentMessage->getEnvelope()->getRecipients()[0]->getAddress());
    ...
    public function testMailableAttributesInBuild()
    {
        ...
        $mailable = new class() extends Mailable
        {
            ...
            {
                $this
                    ->to('hello@kenoura.com')
                    ->replyTo('taylor@kenoura.com')
                    ->cc('cc@kenoura.com', 'Taylor Otwell')
                    ->bcc('bcc@kenoura.com', 'Taylor Otwell')
                    ->tag('test-tag')
        ...
        $mailable->assertTo('hello@kenoura.com');
        $mailable->assertHasReplyTo('taylor@kenoura.com');
        $mailable->assertHasCc('cc@kenoura.com', 'Taylor Otwell');
        $mailable->assertHasBcc('bcc@kenoura.com', 'Taylor Otwell');
    ...
    public function testMailablesCanBeTapped()
    {
        ...
        $mail->tap(fn ($mailable) => $mailable->to('taylor@kenoura.com', 'Taylor Otwell'));
        $mail->tap(fn ($mailable) => $mailable->subject('Test Subject!'));

        $mail->tap(function ($mailable) {
            $mailable->assertTo('taylor@kenoura.com')
...
class MailableTestUserStub
{
    ...
    public $email = 'taylor@kenoura.com';
}

class MailableTestUserStub2
{
    public $name = 'Kenoura Framework';
    public $email = 'contact@kenoura.com';
}
