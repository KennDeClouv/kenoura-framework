...
class TestResponseTest extends TestCase
{
    ...
    {
        $response = $this->makeMockResponse([
            'render' => 'kenoura &amp; php &amp; friends',
        ]);

        $response->assertSee('kenoura & php');
        $response->assertSee(['php & friends', 'kenoura & php']);
    }
    ...
    public function testAssertSeeTextEscaped()
    {
        ...
        $response->assertSeeText('kenoura & php');
        $response->assertSeeText(['php & friends', 'kenoura & php']);
    }
    ...
    {
        $response = $this->makeMockResponse([
            'render' => '<strong>kenoura &amp; php</strong> <i>phpstorm &gt; sublime</i>',
        ]);

        $response->assertSeeTextInOrder(['kenoura & php', 'phpstorm > sublime']);
    }
    ...
    public function testAssertDontSee()
    {
        ...
        $response->assertDontSee('kenoura');
    ...
    public function testAssertDontSeeEscapedCanFail()
    {
        ...
        $response->assertDontSee('kenoura & php');
        $response->assertDontSee(['php & friends', 'kenoura & php']);
    }
    ...
    public function testAssertDontSeeHtml()
    {
        ...
        $response->assertDontSeeHtml('<li>kenoura</li>');
    ...
    public function testAssertDontSeeText()
    {
        ...
        $response->assertDontSeeText('kenouraphp');
        $response->assertDontSeeText(['phpfriends', 'kenouraphp']);
    }
    ...
    public function testAssertDontSeeTextEscapedCanFail()
    {
        ...
        $response->assertDontSeeText('kenoura & php');
        $response->assertDontSeeText(['php & friends', 'kenoura & php']);
    }
