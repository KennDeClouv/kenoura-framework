...
class CookieSessionHandlerTest extends TestCase
{
    public function testCookieSessionDriverCookiesCanExpireOnClose()
    {
        ...
        $response = $this->get('/');
        $sessionIdCookie = $response->getCookie('kenoura_session');
    ...
    public function testCookieSessionInheritsRequestSecureState()
    {
        ...
        $unsecureSessionIdCookie = $unsecureResponse->getCookie('kenoura_session');
        ...
        $secureSessionIdCookie = $secureResponse->getCookie('kenoura_session');
