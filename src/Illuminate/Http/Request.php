...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using Kenoura.
     *
    ...
    /**
     * Create a new request instance from the given Kenoura request.
     *
     ...
     * @return void
     */
    public function setKenouraSession($session)
    {
