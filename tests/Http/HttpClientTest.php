...
class HttpClientTest extends TestCase
{
    ...
    public function testStubbedResponsesAreReturnedAfterFaking()
    {
        ...
        $response = $this->factory->post('http://kenoura.com/test-missing-page');
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_CREATED),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);

        $response = $this->factory->post('http://vapor.kenoura.com');
        $this->assertTrue($response->created());

        $response = $this->factory->post('http://forge.kenoura.com');
    ...
    {
        $this->factory->fake([
            'forge.kenoura.com' => 204,
            'vapor.kenoura.com' => HttpResponse::HTTP_CREATED,
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_ACCEPTED),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_MOVED_PERMANENTLY),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_NO_CONTENT),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_FOUND),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_NOT_MODIFIED),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);

        $response = $this->factory->post('https://vapor.kenoura.com');
        $this->assertTrue($response->notModified());

        $response = $this->factory->post('https://forge.kenoura.com');
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_BAD_REQUEST),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_PAYMENT_REQUIRED),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_REQUEST_TIMEOUT),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_CONFLICT),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_UNPROCESSABLE_ENTITY),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_TOO_MANY_REQUESTS),
            'forge.kenoura.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'kenoura.com' => $this->factory::response('', 401),
        ]);

        $response = $this->factory->post('http://kenoura.com');
    ...
    {
        $this->factory->fake([
            'kenoura.com' => $this->factory::response('', 403),
        ]);
    ...
    {
        $this->factory->fake([
            'kenoura.com' => $this->factory::response('', 404),
        ]);
    ...
    public function testItCanSendUserAgent()
    {
        ...
        $this->factory->withUserAgent('Kenoura')->post('http://foo.com/json');

        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'http://foo.com/json' &&
                $request->hasHeader('User-Agent', 'Kenoura');
        });
    }
    ...
    public function testItOnlySendsOneUserAgentHeader()
    {
        ...
        $this->factory->withUserAgent('Kenoura')
    ...
    public function testSequenceBuilderCanKeepGoingWhenEmpty()
    {
        ...
        $response = $this->factory->get('https://kenoura.com');
        $this->assertSame('Ok', $response->body());

        // The sequence is empty, but it should not fail.
        $this->factory->get('https://kenoura.com');
    }
    ...
    public function testWithCookies()
    {
        ...
        $response = $this->factory->withCookies(
            ['foo' => 'bar'], 'https://kenoura.com'
        )->get('https://kenoura.com');
        ...
        $this->assertSame('https://kenoura.com', $responseCookie['Domain']);
    }
    ...
    public function testWithQueryParameters()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://kenoura.com?foo=bar';
        });
    }
    ...
    public function testWithArrayQueryParameters()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://kenoura.com?foo%5B0%5D=bar&foo%5B1%5D=baz';
        });
    }
    ...
    public function testWithQueryParametersAllowsAddingMoreOnRequest()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://kenoura.com?foo=bar&baz=qux';
        });
    }
    ...
    public function testGetWithArrayQueryParamEncodes()
    {
        ...
        $this->factory->get('http://foo.com/get', ['foo;bar; space test' => 'kenoura']);

        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'http://foo.com/get?foo%3Bbar%3B%20space%20test=kenoura'
                && $request['foo;bar; space test'] === 'kenoura';
        });
    }
    ...
    public function testOnErrorDoesntCallClosureOnInformational()
    {
        ...
        $client = $this->factory->fake([
            'kenoura.com' => $this->factory::response('', 101),
        ]);

        $response = $client->get('kenoura.com')
    ...
    public function testOnErrorDoesntCallClosureOnSuccess()
    {
        $status = 0;
        $client = $this->factory->fake([
            'kenoura.com' => $this->factory::response('', 201),
        ]);
    ...
    public function testOnErrorDoesntCallClosureOnRedirection()
    {
        $status = 0;
        $client = $this->factory->fake([
            'kenoura.com' => $this->factory::response('', 301),
        ]);
    ...
    public function testOnErrorCallsClosureOnServerError()
    {
        $status = 0;
        $client = $this->factory->fake([
            'kenoura.com' => $this->factory::response('', 501),
        ]);
    ...
    public function testMiddlewareRunsInPool()
    {
        ...
        $responses = $this->factory->pool(fn (Pool $pool) => [
            $pool->withMiddleware($middleware)->post('https://example.com', ['hyped-for' => 'kenoura-movie']),
        ]);
        ...
        $this->assertSame(['hyped-for' => 'kenoura-movie'], json_decode(tap($history[0]['request']->getBody())->rewind()->getContents(), true));
    }
    ...
    public function testMiddlewareRunsWhenFaked()
    {
        ...
        $response = $pendingRequest->post('https://example.com', ['hyped-for' => 'kenoura-movie']);
    ...
    public function testMiddlewareRunsAndCanChangeRequestOnAssertSent()
    {
        ...
        $pendingRequest->post('https://kenoura.example', ['kenoura' => 'framework']);

        $this->factory->assertSent(function (Request $request) {
            return
                $request->url() === 'https://kenoura.example' &&
    ...
    public function testItCanEnforceFaking()
    {
        ...
        $this->factory->fake(['https://vapor.kenoura.com' => Factory::response('ok', 200)]);
        $this->factory->fake(['https://forge.kenoura.com' => Factory::response('ok', 200)]);

        $responses = [];
        $responses[] = $this->factory->get('https://vapor.kenoura.com')->body();
        $responses[] = $this->factory->get('https://forge.kenoura.com')->body();
        $this->assertSame(['ok', 'ok'], $responses);

        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessage('Attempted request to [https://kenoura.com] without a matching fake.');
    ...
    public function testItCanSubstituteUrlParams(): void
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://kenoura.com/docs/9.x/validation';
        });
    }
    ...
    public function testItCanAddGlobalMiddleware()
    {
        ...
        $this->factory->globalMiddleware(Middleware::mapRequest(function ($request) {
            ...
            return $request->withHeader('User-Agent', 'Kenoura Framework/1.0')
        ...
        $responses[] = $this->factory->post('http://forge.kenoura.com');
        $responses[] = $this->factory->withHeader('shared', 'local')->post('http://vapor.kenoura.com');

        $this->assertCount(2, $requests);
        $this->assertCount(2, $responses);

        $this->assertSame(['Kenoura Framework/1.0'], $requests[0]->header('User-Agent'));
        ...
        $this->assertSame(['Kenoura Framework/1.0'], $requests[1]->header('User-Agent'));
    ...
    public function testItCanAddGlobalRequestMiddleware()
    {
        ...
        $this->factory->post('http://forge.kenoura.com');
        $this->factory->post('http://kenoura.com');
    ...
    public function testItCanAddGlobalResponseMiddleware()
    {
        ...
        $responses[] = $this->factory->post('http://forge.kenoura.com');
        $responses[] = $this->factory->post('http://kenoura.com');
    ...
    public function testItReturnsResponse(): void
    {
        ...
        $response = $this->factory->get('http://kenoura.com');
    ...
    public function testItCanReturnCustomResponseClass(): void
    {
        ...
        $response = $factory->get('http://kenoura.fake');
