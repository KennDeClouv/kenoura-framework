...
class HandleExceptionsTest extends TestCase
{
    ...
    public function testPhpDeprecations()
    {
        ...
        $logger->expects('warning')->with(sprintf('%s in %s on line %s',
            ...
            '/home/user/kenoura/routes/web.php',
            17
        ));
    ...
    public function testPhpDeprecationsWithStackTraces()
    {
        ...
        $logger->expects('warning')->with(
            m::on(fn (string $message) => (bool) preg_match(
                <<<REGEXP
                #ErrorException: str_contains\(\): Passing null to parameter \#2 \(\\\$needle\) of type string is deprecated in /home/user/kenoura/routes/web\.php:17
                Stack trace:
    ...
    public function testErrors()
    {
        ...
        $this->handleExceptions()->handleError(
            ...
            '/home/user/kenoura/src/Providers/AppServiceProvider.php',
            17
        );
    }
