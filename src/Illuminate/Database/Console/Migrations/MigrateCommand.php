...
class MigrateCommand extends BaseCommand implements Isolatable
{
    ...
    {
        if ($this->kenoura['config']->get("database.connections.{$connection->getName()}.database") !== $connection->getDatabaseName()) {
            return false;
        }
        ...
        try {
            ...
            $this->kenoura['config']->set("database.connections.{$connection->getName()}.database", $connection->getDatabaseName());
        }
    }
