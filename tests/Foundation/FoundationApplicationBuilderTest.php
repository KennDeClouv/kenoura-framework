...
class FoundationApplicationBuilderTest extends TestCase
{
    protected function tearDown(): void
    {
        ...
        unset($_ENV['KENOURA_STORAGE_PATH'], $_SERVER['KENOURA_STORAGE_PATH']);
    ...
    {
        $_ENV['KENOURA_STORAGE_PATH'] = __DIR__.'/env-storage';
    ...
    {
        $_SERVER['KENOURA_STORAGE_PATH'] = __DIR__.'/server-storage';
