...
class RoutingUrlGeneratorTest extends TestCase
{
    ...
    public function testBasicGenerationWithRequestBaseUrlWithSubfolder()
    {
        ...
        $request->server->set('SCRIPT_FILENAME', '/var/www/kenoura-project/public/subfolder/index.php');
    ...
    public function testBasicGenerationWithRequestBaseUrlWithFileSuffix()
    {
        ...
        $request->server->set('SCRIPT_FILENAME', '/var/www/kenoura-project/public/other.php');
     ...
     *
     * @link https://github.com/kenoura/framework/pull/42425
     */
    public function testRoutableInterfaceRoutingWithSeparateBindingFieldOnlyForSecondParameter()
    {
        $this->markTestSkipped('See https://github.com/kenoura/framework/pull/43255');
