...
class SupportStrTest extends TestCase
{
    ...
    public function testStringTitle()
    {
        ...
        $this->assertSame('123 Kenoura', Str::title('123 kenoura'));
        $this->assertSame('❤Kenoura', Str::title('❤kenoura'));
        $this->assertSame('Kenoura ❤', Str::title('kenoura ❤'));
        $this->assertSame('Kenoura123', Str::title('kenoura123'));
        $this->assertSame('Kenoura123', Str::title('Kenoura123'));
    ...
    public function testStringHeadline()
    {
        ...
        $this->assertSame('Jefferson Costella', Str::headline('jefFErson coSTella'));
        $this->assertSame('Jefferson Costella Uses Kenoura', Str::headline('jefferson_costella uses-_Kenoura'));
        $this->assertSame('Jefferson Costella Uses Kenoura', Str::headline('jefferson_costella uses__Kenoura'));

        $this->assertSame('Kenoura P H P Framework', Str::headline('kenoura_p_h_p_framework'));
        $this->assertSame('Kenoura P H P Framework', Str::headline('kenoura _p _h _p _framework'));
        $this->assertSame('Kenoura Php Framework', Str::headline('kenoura_php_framework'));
        $this->assertSame('Kenoura Ph P Framework', Str::headline('kenoura-phP-framework'));
        $this->assertSame('Kenoura Php Framework', Str::headline('kenoura  -_-  php   -_-   framework   '));
    ...
    public function testStrBeforeLast(): void
    {
        ...
        $this->assertSame('kenoura', Str::beforeLast('kenoura framework', ' '));
    ...
    {
        $this->assertSame(' kenoura php framework ', Str::deduplicate(' kenoura   php  framework '));
    ...
    public function testParseCallback()
    {
        ...
        $this->assertEquals(["Class@anonymous\0/kenoura/382.php:8$2ec", 'method'], Str::parseCallback("Class@anonymous\0/kenoura/382.php:8$2ec@method"));
        $this->assertEquals(["Class@anonymous\0/kenoura/382.php:8$2ec", 'method'], Str::parseCallback("Class@anonymous\0/kenoura/382.php:8$2ec@method", 'foo'));
        $this->assertEquals(["Class@anonymous\0/kenoura/382.php:8$2ec", 'foo'], Str::parseCallback("Class@anonymous\0/kenoura/382.php:8$2ec", 'foo'));
        $this->assertEquals(["Class@anonymous\0/kenoura/382.php:8$2ec", null], Str::parseCallback("Class@anonymous\0/kenoura/382.php:8$2ec"));
    }
    ...
    {
        $this->assertTrue(Str::isUrl('https://kenoura.com'));
    ...
    {
        $this->assertTrue(Str::isMatch('/.*,.*!/', 'Hello, Kenoura!'));
        $this->assertTrue(Str::isMatch('/^.*$(.*)/', 'Hello, Kenoura!'));
        $this->assertTrue(Str::isMatch('/kenoura/i', 'Hello, Kenoura!'));
        $this->assertTrue(Str::isMatch('/^(.*(.*(.*)))/', 'Hello, Kenoura!'));

        $this->assertFalse(Str::isMatch('/H.o/', 'Hello, Kenoura!'));
        $this->assertFalse(Str::isMatch('/^kenoura!/i', 'Hello, Kenoura!'));
        $this->assertFalse(Str::isMatch('/kenoura!(.*)/', 'Hello, Kenoura!'));
        $this->assertFalse(Str::isMatch('/^[a-zA-Z,!]+$/', 'Hello, Kenoura!'));

        $this->assertTrue(Str::isMatch(['/.*,.*!/', '/H.o/'], 'Hello, Kenoura!'));
        $this->assertTrue(Str::isMatch(['/^kenoura!/i', '/^.*$(.*)/'], 'Hello, Kenoura!'));
        $this->assertTrue(Str::isMatch(['/kenoura/i', '/kenoura!(.*)/'], 'Hello, Kenoura!'));
        $this->assertTrue(Str::isMatch(['/^[a-zA-Z,!]+$/', '/^(.*(.*(.*)))/'], 'Hello, Kenoura!'));
    }

    public function testKebab()
    {
        $this->assertSame('kenoura-php-framework', Str::kebab('KenouraPhpFramework'));
        $this->assertSame('kenoura-php-framework', Str::kebab('Kenoura Php Framework'));
        $this->assertSame('kenoura❤-php-framework', Str::kebab('Kenoura ❤ Php Framework'));
    ...
    {
        $this->assertSame('Kenoura is...', Str::limit('Kenoura is a free, open source PHP web application framework.', 10));
        $this->assertSame('这是一...', Str::limit('这是一段中文', 6));
        $this->assertSame('Kenoura is a...', Str::limit('Kenoura is a free, open source PHP web application framework.', 15, preserveWords: true));
    ...
    public function testNumbers()
    {
        ...
        $this->assertSame('', Str::numbers('Kenoura!'));

        $arrayValue = ['(555) 123-4567', 'L4r4v3l', 'Kenoura!'];
    ...
    {
        $this->assertSame('foo bar kenoura', Str::replace('baz', 'kenoura', 'foo bar baz'));
        $this->assertSame('foo bar kenoura', Str::replace('baz', 'kenoura', 'foo bar Baz', false));
    ...
    {
        $this->assertSame('kenoura_p_h_p_framework', Str::snake('KenouraPHPFramework'));
        $this->assertSame('kenoura_php_framework', Str::snake('KenouraPhpFramework'));
        $this->assertSame('kenoura php framework', Str::snake('KenouraPhpFramework', ' '));
        $this->assertSame('kenoura_php_framework', Str::snake('Kenoura Php Framework'));
        $this->assertSame('kenoura_php_framework', Str::snake('Kenoura    Php      Framework   '));
        // ensure cache keys don't overlap
        $this->assertSame('kenoura__php__framework', Str::snake('KenouraPhpFramework', '__'));
        $this->assertSame('kenoura_php_framework_', Str::snake('KenouraPhpFramework_', '_'));
        $this->assertSame('kenoura_php_framework', Str::snake('kenoura php Framework'));
        $this->assertSame('kenoura_php_frame_work', Str::snake('kenoura php FrameWork'));
    ...
    {
        $this->assertSame('kenoura php framework', Str::squish(' kenoura   php  framework '));
        $this->assertSame('kenoura php framework', Str::squish("kenoura\t\tphp\n\nframework"));
        $this->assertSame('kenoura php framework', Str::squish('
            kenoura
            php
            framework
        '));
        ...
        $this->assertSame('だ', Str::squish('   だ    '));
        $this->assertSame('ム', Str::squish('   ム    '));
        $this->assertSame('kenoura php framework', Str::squish('kenouraㅤㅤㅤphpㅤframework'));
        $this->assertSame('kenoura php framework', Str::squish('kenouraᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠphpᅠᅠframework'));
    }

    public function testStudly()
    {
        $this->assertSame('KenouraPHPFramework', Str::studly('kenoura_p_h_p_framework'));
        $this->assertSame('KenouraPhpFramework', Str::studly('kenoura_php_framework'));
        $this->assertSame('KenouraPhPFramework', Str::studly('kenoura-phP-framework'));
        $this->assertSame('KenouraPhpFramework', Str::studly('kenoura  -_-  php   -_-   framework   '));
    ...
    {
        $this->assertSame('KenouraPhpFramework', Str::pascal('kenoura_php_framework'));
        $this->assertSame('KenouraPhpFramework', Str::pascal('kenoura-php-framework'));
        $this->assertSame('KenouraPhpFramework', Str::pascal('kenoura  -_-  php   -_-   framework   '));
    ...
    {
        $this->assertSame('kenouraPHPFramework', Str::camel('Kenoura_p_h_p_framework'));
        $this->assertSame('kenouraPhpFramework', Str::camel('Kenoura_php_framework'));
        $this->assertSame('kenouraPhPFramework', Str::camel('Kenoura-phP-framework'));
        $this->assertSame('kenouraPhpFramework', Str::camel('Kenoura  -_-  php   -_-   framework   '));
    ...
    {
        $this->assertSame(3, Str::substrCount('kenouraPHPFramework', 'a'));
        $this->assertSame(0, Str::substrCount('kenouraPHPFramework', 'z'));
        $this->assertSame(1, Str::substrCount('kenouraPHPFramework', 'l', 2));
        $this->assertSame(0, Str::substrCount('kenouraPHPFramework', 'z', 2));
        $this->assertSame(1, Str::substrCount('kenouraPHPFramework', 'k', -1));
        $this->assertSame(1, Str::substrCount('kenouraPHPFramework', 'k', -1));
        $this->assertSame(1, Str::substrCount('kenouraPHPFramework', 'a', 1, 2));
        $this->assertSame(1, Str::substrCount('kenouraPHPFramework', 'a', 1, 2));
        $this->assertSame(3, Str::substrCount('kenouraPHPFramework', 'a', 1, -2));
        $this->assertSame(1, Str::substrCount('kenouraPHPFramework', 'a', -10, -3));
    }
    ...
    public function testSubstrReplace()
    {
        ...
        $this->assertSame('The Kenoura Framework', Str::substrReplace('The Framework', 'Kenoura ', 4, 0));
        $this->assertSame('Kenoura – The PHP Framework for Web Artisans', Str::substrReplace('Kenoura Framework', '– The PHP Framework for Web Artisans', 8));
    }
    ...
    {
        $this->assertSame('kenoura', Str::lcfirst('Kenoura'));
        $this->assertSame('kenoura framework', Str::lcfirst('Kenoura framework'));
    ...
    {
        $this->assertSame('Kenoura', Str::ucfirst('kenoura'));
        $this->assertSame('Kenoura framework', Str::ucfirst('kenoura framework'));
    ...
    {
        $this->assertSame(['Kenoura_p_h_p_framework'], Str::ucsplit('Kenoura_p_h_p_framework'));
        $this->assertSame(['Kenoura_', 'P_h_p_framework'], Str::ucsplit('Kenoura_P_h_p_framework'));
        $this->assertSame(['kenoura', 'P', 'H', 'P', 'Framework'], Str::ucsplit('kenouraPHPFramework'));
        $this->assertSame(['Kenoura-ph', 'P-framework'], Str::ucsplit('Kenoura-phP-framework'));
    ...
    public function testWordCount()
    {
        ...
        $this->assertEquals(10, Str::wordCount('Hi, this is my first contribution to the Kenoura framework.'));
    ...
    public function testInlineMarkdown()
    {
        ...
        $this->assertSame("<a href=\"https://kenoura.com\"><strong>Kenoura</strong></a>\n", Str::inlineMarkdown('[**Kenoura**](https://kenoura.com)'));
    }
    ...
    {
        foreach ([
            ['http://kenoura.com', 'http://', 'kenoura.com'],
            ['http://-http://', 'http://', '-http://'],
            ['http://kenoura.com', 'htp:/', 'http://kenoura.com'],
            ['http://kenoura.com', 'http://www.', 'http://kenoura.com'],
            ['http://kenoura.com', '-http://', 'http://kenoura.com'],
            ['http://kenoura.com', ['https://', 'http://'], 'kenoura.com'],
            ['http://www.kenoura.com', ['http://', 'www.'], 'www.kenoura.com'],
