...
class SupportUriTest extends TestCase
{
    ...
    {
        $uri = Uri::of($originalUri = 'https://kenoura.com/docs/installation');

        $this->assertEquals('https', $uri->scheme());
        $this->assertNull($uri->user());
        $this->assertNull($uri->password());
        $this->assertEquals('kenoura.com', $uri->host());
        ...
        $uri = Uri::of('https://taylor:password@kenoura.com/docs/installation?version=1#hello');
    ...
    public function test_uri_building()
    {
        ...
        $this->assertEquals('https://taylor:password@kenoura.com:80/docs/installation?version=1#hello', (string) $uri);
    }

    public function test_complicated_query_string_manipulation()
    {
        $uri = Uri::of('https://kenoura.com');
        ...
        $uri = Uri::of('https://kenoura.com?tags[]=foo');
        ...
        $uri = Uri::of('https://kenoura.com?tag=foo');
    ...
    {
        $uri = Uri::of('https://kenoura.com/docs/11.x/installation')->withQuery(['tags' => ['first', 'second']]);

        $this->assertEquals('https://kenoura.com/docs/11.x/installation?tags[0]=first&tags[1]=second', $uri->decode());
    }
}
