...
class DatabaseEloquentIntegrationTest extends TestCase
{
    ...
    public function testBasicModelRetrieval()
    {
        ...
        $this->assertTrue(EloquentTestUser::where('email', 'mohamed@kenoura.com')->doesntExist());
    ...
    public function testFirstOrCreate()
    {
        ...
        $user4 = EloquentTestUser::firstOrCreate(
            ['name' => 'Dries Vints'],
            ['name' => 'Nuno Maduro', 'email' => 'nuno@kenoura.com']
        );
    ...
    {
        $user = EloquentTestUser::create(['email' => 'taylor@kenoura.com']);
        $this->connection()->transaction(function () use ($user) {
            try {
                $this->connection()->transaction(function () use ($user) {
                    $user->email = 'otwell@kenoura.com';
                    $user->save();
                    throw new Exception;
                });
            } catch (Exception) {
            ...
            $this->assertSame('taylor@kenoura.com', $user->email);
        });
    }
    ...
    public function testNestedTransactionsUsingSaveOrFailWillSucceed()
    {
        ...
        $this->connection()->transaction(function () use ($user) {
            ...
            $user = EloquentTestUser::first();
            $this->assertSame('otwell@kenoura.com', $user->email);
    ...
    public function testTimestampsUsingOldSqlServerDateFormatFallbackToDefaultParsing()
    {
        ...
        // No longer throwing exception since Kenoura 7,
