...
class DownCommand extends Command
{
    ...
    {
        try {
            if ($this->kenoura->maintenanceMode()->active() && ! $this->getSecret()) {
            ...
            $this->kenoura->maintenanceMode()->activate($downFilePayload);
            ...
            $this->kenoura->get('events')->dispatch(new MaintenanceModeEnabled());
    ...
    {
        try {
            return $this->kenoura->make(PreventRequestsDuringMaintenance::class)->getExcludedPaths();
        } catch (Throwable) {
            return [];
        }
    }
